...
import com.lxy.tc.vo.QuestionWriteForm;
...
public class QuestionController {
   ...
   @PostMapping("/question/write")
    public synchronized String write(QuestionWriteForm questionWriteForm){
        ...
        question.setQid(UUID.randomUUID().toString().replaceAll("-",""));
        ...
        question.setGmtCreate(new Timestamp(new Date().getTime()));
        question.setGmtUpdate(new Timestamp(new Date().getTime()));
        // 存储对象
   ...
   public String editor(Question question){
        ...
        queryQuestion.setGmtUpdate(new Timestamp(new Date().getTime()));
